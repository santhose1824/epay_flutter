...
class GPHomeScreenState extends State<GPHomeScreen> {
  ...
  style: ButtonStyle(
    ...
    foregroundColor: MaterialStateProperty.all<Color>(GPAppColor),
    overlayColor: MaterialStateProperty.all<Color>(GPAppColor),
    backgroundColor: MaterialStateProperty.all<Color>(GPLightBlue),
  ),
